...
{
    public class GuidEntityRepositoryMock<T> : EntityRepositoryMock<T>, IGuidEntityRepository<T>
        where T : class, IGuidEntity
    {
        public GuidEntityRepositoryMock()
            : base()
        {
        }

        public GuidEntityRepositoryMock(IList<T> dbSet)
            : base()
        {
            this._dbSet = dbSet;
        }
        ...
        public void Delete(IGuidEntity guidEntity)
        {
